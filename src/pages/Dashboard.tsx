    ...
    return (
        <div className="space-y-6">
            ...
            <div>
                ...
                <p className="text-gray-600 dark:text-gray-300 mt-1">Welcome to Engage360 - your relationship management hub</p>
            </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
                <Link
                    to="/people"
                    className="bg-white dark:bg-gray-800 p-6 rounded-lg shadow hover:shadow-md transition-shadow border border-gray-200 dark:border-gray-700 group"
                >
                ...
                >
                    <div className="flex items-center space-x-3">
                        ...
                        <div>
                            ...
                            <p className="text-sm text-gray-600 dark:text-gray-400">Organize teams</p>
                        </div>
                    </div>
                </Link>
                ...
                >
                    <div className="flex items-center space-x-3">
                        ...
                        <div>
                            ...
                            <p className="text-sm text-gray-600 dark:text-gray-400">Track tasks</p>
                        </div>
                    </div>
                </Link>
            </div>
