...
export default function ActionItemDetail() {
    ...
    if (!actionItem) {
        return (
            <div className="space-y-6">
                <Link to="/action-items" className="flex items-center gap-2 text-gray-600 dark:text-gray-300 hover:text-gray-900 dark:hover:text-white transition-colors">
                    <ArrowLeft className="h-4 w-4" />
                    Back to Action Items
                </Link>
                <div className="bg-white dark:bg-gray-800 rounded-lg shadow p-6 transition-colors">
                    <p className="text-gray-600 dark:text-gray-300">Action item not found</p>
                </div>
            </div>
        );
    }
            ...
            <div className="bg-white dark:bg-gray-800 rounded-lg shadow p-6 transition-colors">
                <div className="flex items-start justify-between mb-6">
                    <div className="flex items-center gap-3">
                        ...
                        <div>
                            <h1 className="text-2xl font-bold text-gray-900 dark:text-white">{actionItem.title}</h1>
                ...
                {actionItem.description && (
                    <div className="mb-6">
                        ...
                        <div className="whitespace-pre-wrap text-gray-700">{actionItem.description}</div>
                    </div>
                )}
